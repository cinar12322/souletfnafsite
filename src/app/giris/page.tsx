...
function GirisContent() {
  ...
  useEffect(() => {
    getProviders().then((p) => setProviders(((p ?? {}) as unknown) as ProviderMap));
  }, []);
      ...
      <div className="relative z-10 w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <div className="p-6 rounded-2xl border border-white/5 bg-surface">
            {registered && (
              <div className="mb-4 p-3 bg-green-500/10 border border-green-500/20 rounded-lg text-xs text-green-500 text-center">
